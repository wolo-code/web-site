<div id='message'>
	...
	<p>
		Wolo Codes alleviates these issues by providing the same coordinate in a different format, i.e. using words that we are all familiar with - which makes it far easier to handle and communicate.
	</p>
	<p>
		Wolo Codes transform the exact coordinates into simple words e.g. \ cat apple tomato /.
	...
	<p>
		<a class="content-link XURL" href='/about_me' data-target='about_me' data-title='About me'>Ujjwal Singh</a> the creator of Wolo Codes had first invented a generic system to communicate digital data with words from a set of just 1,024 words, naming it WCodes. And had presented a working prototype that would convert between coordinates and words back in early 2013 on a crowdfunding platform and his website wcodes.org.
	</p>
	<p>
	...
	<p>
		Since the app depends on a city - very remote places that have no city associated with them will first require a name to be associated with that area in order for Wolo codes to be usable in the area.
	</p>
	<p>
